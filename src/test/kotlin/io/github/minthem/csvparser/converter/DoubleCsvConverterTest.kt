...
class DoubleCsvConverterTest {
    ...
    inner class DeserializeTest {
        ...
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.DoubleCsvConverterTest#deserializeProvider")
        ...
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.DoubleCsvConverterTest#invalidDeserializeProvider")
    ...
    inner class SerializeTest {
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.DoubleCsvConverterTest#serializeProvider")
