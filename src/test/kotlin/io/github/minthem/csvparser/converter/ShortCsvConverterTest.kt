...
class ShortCsvConverterTest {
    ...
    inner class DeserializeTest {
        ...
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.ShortCsvConverterTest#deserializeProvider")
        ...
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.ShortCsvConverterTest#invalidDeserializeProvider")
    ...
    inner class SerializeTest {
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.ShortCsvConverterTest#serializeProvider")
