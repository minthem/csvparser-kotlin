...
class FloatCsvConverterTest {
    ...
    inner class DeserializeTest {
        ...
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.FloatCsvConverterTest#deserializeProvider")
        ...
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.FloatCsvConverterTest#invalidDeserializeProvider")
    ...
    inner class SerializeTest {
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.FloatCsvConverterTest#serializeProvider")
