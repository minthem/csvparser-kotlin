...
class LongCsvConverterTest {
    ...
    inner class DeserializeTest {
        ...
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.LongCsvConverterTest#deserializeProvider")
        ...
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.LongCsvConverterTest#invalidDeserializeProvider")
    ...
    inner class SerializeTest {
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.LongCsvConverterTest#serializeProvider")
