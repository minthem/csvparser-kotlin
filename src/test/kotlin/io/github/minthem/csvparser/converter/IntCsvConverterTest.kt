...
class IntCsvConverterTest {
    ...
    inner class DeserializeTest {
        ...
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.IntCsvConverterTest#deserializeProvider")
        ...
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.IntCsvConverterTest#invalidDeserializeProvider")
    ...
    inner class SerializeTest {
        @ParameterizedTest
        @MethodSource("io.github.minthem.csvparser.converter.IntCsvConverterTest#serializeProvider")
