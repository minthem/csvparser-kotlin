...
class BooleanCsvConverterTest {
    ...
    inner class CaseSensitiveTest {
        ...
        inner class DeserializeTest {
            ...
            @ParameterizedTest
            @MethodSource("io.github.minthem.csvparser.converter.BooleanCsvConverterTest#truthyFalsyCaseSensitiveProvider")
        ...
        inner class SerializeTest {
            @ParameterizedTest
            @MethodSource("io.github.minthem.csvparser.converter.BooleanCsvConverterTest#serializeCaseSensitiveProvider")
    ...
    inner class CaseInsensitiveTest {
        ...
        inner class DeserializeTest {
            ...
            @ParameterizedTest
            @MethodSource("io.github.minthem.csvparser.converter.BooleanCsvConverterTest#truthyFalsyCaseInsensitiveProvider")
        ...
        inner class SerializeTest {
            @ParameterizedTest
            @MethodSource("io.github.minthem.csvparser.converter.BooleanCsvConverterTest#serializeCaseInsensitiveProvider")
            fun `serialize should pick first token of true or false side`(
                value: Boolean,
                trueValues: List<String>,
                falseValues: List<String>,
