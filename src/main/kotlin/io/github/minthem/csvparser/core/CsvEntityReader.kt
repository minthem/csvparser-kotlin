...
import io.github.minthem.csvparser.config.ReaderConfig
import io.github.minthem.csvparser.converter.CsvConverter
import io.github.minthem.csvparser.exception.CsvEntityConstructionException
...
import io.github.minthem.csvparser.exception.CsvFieldIndexOutOfRangeException
import io.github.minthem.csvparser.exception.CsvFieldNotFoundInHeaderException
...
class CsvEntityReader<T : Any>(
     ...
     * errors are thrown as [io.github.minthem.csvparser.exception.CsvEntityException] subtypes during iteration.
     */
